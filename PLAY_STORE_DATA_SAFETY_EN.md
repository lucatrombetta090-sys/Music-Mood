...
**Yes**, if the published build includes configurable Last.fm integration, because the app may send username, API key and required request parameters to the Last.fm API when the user manually presses **Refresh Last.fm**.
...
- Yes, for Last.fm calls, if made over HTTPS.
...
The app may transfer data to Last.fm only when the user configures Last.fm and manually presses **Refresh Last.fm**.

Data potentially transferred to Last.fm:

- Last.fm username
- Last.fm API key
- request parameters required by the API

Data received from Last.fm:
...
- Last.fm API key stored locally
- Local Last.fm cache
...
Yes, cautiously for Last.fm username/API key and optional Last.fm data, if the integration is included in the published build.

### Data shared

Yes, cautiously with Last.fm, only when the user uses the optional integration.

### Data encrypted in transit

Yes, for Last.fm calls over HTTPS.
